 ...
 *
 * Contributors: IBM Corporation - initial API and implementation Pablo Cabrera
 * <pablo.cabrera@mulesoft.com> - Bug 428355
 *******************************************************************************/
...
public abstract class AboutData {
    ...
    protected AboutData(final String providerName, final String name, final String version, final String id) {
     ...
     */
    public static void sortByProvider(final boolean reverse, final AboutData[] infos) {
        if (reverse) {
            reverse(infos);
            return;
        }
     ...
     *            the data to be sorted
     */
    public static void sortByName(final boolean reverse, final AboutData[] infos) {
        if (reverse) {
            reverse(infos);
            return;
        }
     ...
     *            the data to be sorted
     */
    public static void sortByVersion(final boolean reverse, final AboutData[] infos) {
        if (reverse) {
            reverse(infos);
            return;
        }
    ...
    protected static ImageDescriptor getImage(final String value) {
