...
public final class ConfigurationInfo {
    ...
    public static String getSystemSummary() {
        ...
        writer.println(
                NLS.bind(WorkbenchMessages.SystemSummary_timeStamp, DateFormat.getDateTimeInstance(DateFormat.FULL, DateFormat.FULL).format(new Date())));
    ...
    private static void appendExtensions(final PrintWriter writer) {
        ...
        IConfigurationElement[] configElements = getSortedExtensions(
                Platform.getExtensionRegistry().getConfigurationElementsFor(DialogPlugin.ID, IWorkbenchRegistryConstants.PL_SYSTEM_SUMMARY_SECTIONS));
    ...
    public static IConfigurationElement[] getSortedExtensions(final IConfigurationElement[] configElements) {
        ...
        Arrays.sort(configElements, new Comparator<IConfigurationElement>() {
            ...
            public int compare(final IConfigurationElement a, final IConfigurationElement b) {
                IConfigurationElement element1 = a;
                IConfigurationElement element2 = b;
