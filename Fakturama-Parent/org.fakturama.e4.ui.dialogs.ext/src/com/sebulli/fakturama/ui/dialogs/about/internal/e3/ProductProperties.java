...
public class ProductProperties extends BrandingProperties implements IProductConstants {
     ...
     *            must not be null
     */
    public ProductProperties(final IProduct product) {
        if (product == null) {
     ...
     * @see org.eclipse.swt.widgets.Display#setAppName
     */
    public static String getAppName(final IProduct product) {
     ...
     * 250x330 pixels) is shown with the "aboutText" blurb beside it.
     */
    public static ImageDescriptor getAboutImage(final IProduct product) {
    ...
    public static ImageDescriptor[] getWindowImages(final IProduct product) {
     ...
     * org.eclipse.ui.e4.intro extension point should be used instead.
     */
    public static URL getWelcomePageUrl(final IProduct product) {
     ...
     * window title and the About action.
     */
    public static String getProductName(final IProduct product) {
     ...
     */
    public static String getProductId(final IProduct product) {
