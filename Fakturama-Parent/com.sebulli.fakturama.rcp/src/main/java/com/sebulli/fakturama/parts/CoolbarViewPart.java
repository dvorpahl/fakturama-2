...
/**
 * Composite for the Coolbar. Since this couldn't configured via Application
 * Model we have to implement it ourself. The Application Model Toolbar doesn't
 * support text below button (or you write a new renderer, what I didn't want).
 * 
 */
public class CoolbarViewPart {
    ...
    public void createControls(final Composite parent) {
        ...
        createToolItem(toolBar, CommandIds.CMD_CALL_EDITOR, msg.toolbarNewOfferName, tooltipPrefix + msg.mainMenuNewOffer,
                Icon.ICON_OFFER_NEW.getImageDescriptor(IconSize.ToolbarIconSize), null, Constants.TOOLBAR_SHOW_DOCUMENT_NEW_OFFER,
                createCommandParams(DocumentType.OFFER)).ifPresent(e -> toolbarmgr2.add(e));
        createToolItem(toolBar, CommandIds.CMD_CALL_EDITOR, msg.toolbarNewOrderName, tooltipPrefix + msg.mainMenuNewOrder,
                Icon.ICON_ORDER_NEW.getImageDescriptor(IconSize.ToolbarIconSize), null, Constants.TOOLBAR_SHOW_DOCUMENT_NEW_ORDER,
                createCommandParams(DocumentType.ORDER)).ifPresent(e -> toolbarmgr2.add(e));
        createToolItem(toolBar, CommandIds.CMD_CALL_EDITOR, msg.toolbarNewConfirmationName, tooltipPrefix + msg.mainMenuNewConfirmation,
                Icon.ICON_CONFIRMATION_NEW.getImageDescriptor(IconSize.ToolbarIconSize), null, Constants.TOOLBAR_SHOW_DOCUMENT_NEW_CONFIRMATION,
                createCommandParams(DocumentType.CONFIRMATION)).ifPresent(e -> toolbarmgr2.add(e));
        createToolItem(toolBar, CommandIds.CMD_CALL_EDITOR, msg.toolbarNewInvoiceName, tooltipPrefix + msg.mainMenuNewInvoice,
                Icon.ICON_INVOICE_NEW.getImageDescriptor(IconSize.ToolbarIconSize), null, Constants.TOOLBAR_SHOW_DOCUMENT_NEW_INVOICE,
                createCommandParams(DocumentType.INVOICE)).ifPresent(e -> toolbarmgr2.add(e));
        createToolItem(toolBar, CommandIds.CMD_CALL_EDITOR, msg.toolbarNewDeliveryName, tooltipPrefix + msg.mainMenuNewDeliverynote,
                Icon.ICON_DELIVERY_NEW.getImageDescriptor(IconSize.ToolbarIconSize), null, Constants.TOOLBAR_SHOW_DOCUMENT_NEW_DELIVERY,
                createCommandParams(DocumentType.DELIVERY)).ifPresent(e -> toolbarmgr2.add(e));
        createToolItem(toolBar, CommandIds.CMD_CALL_EDITOR, msg.toolbarNewCreditName, tooltipPrefix + msg.mainMenuNewCredit,
                Icon.ICON_CREDIT_NEW.getImageDescriptor(IconSize.ToolbarIconSize), null, Constants.TOOLBAR_SHOW_DOCUMENT_NEW_CREDIT,
                createCommandParams(DocumentType.CREDIT)).ifPresent(e -> toolbarmgr2.add(e));
        createToolItem(toolBar, CommandIds.CMD_CALL_EDITOR, msg.toolbarNewDocumentDunningName, tooltipPrefix + msg.mainMenuNewDunning,
                Icon.ICON_DUNNING_NEW.getImageDescriptor(IconSize.ToolbarIconSize), null, Constants.TOOLBAR_SHOW_DOCUMENT_NEW_DUNNING,
                createCommandParams(DocumentType.DUNNING)).ifPresent(e -> toolbarmgr2.add(e));
        createToolItem(toolBar, CommandIds.CMD_CALL_EDITOR, msg.documentTypeProforma, tooltipPrefix + msg.documentTypeProforma,
                Icon.ICON_PROFORMA_NEW.getImageDescriptor(IconSize.ToolbarIconSize), null, Constants.TOOLBAR_SHOW_DOCUMENT_NEW_PROFORMA,
                createCommandParams(DocumentType.PROFORMA)).ifPresent(e -> toolbarmgr2.add(e));
        ...
        createToolItem(toolBar, CommandIds.CMD_CALL_EDITOR, msg.toolbarNewProductName, msg.commandNewProductTooltip,
                Icon.ICON_PRODUCT_NEW.getImageDescriptor(IconSize.ToolbarIconSize), null, Constants.TOOLBAR_SHOW_NEW_PRODUCT, params)
        ...
        createToolItem(toolBar, CommandIds.CMD_CALL_EDITOR, msg.toolbarNewExpenditurevoucherName, tooltipPrefix + msg.mainMenuNewExpenditurevoucher,
                Icon.ICON_EXPENDITURE_VOUCHER_NEW.getImageDescriptor(IconSize.ToolbarIconSize), null, Constants.TOOLBAR_SHOW_NEW_EXPENDITUREVOUCHER, params)
                .ifPresent(e -> toolbarmgr3.add(e));
        params = new HashMap<>();
        params.put(CallEditor.PARAM_EDITOR_TYPE, ReceiptVoucherEditor.ID);
        createToolItem(toolBar, CommandIds.CMD_CALL_EDITOR, msg.toolbarNewReceiptvoucherName, tooltipPrefix + msg.mainMenuNewReceiptvoucher,
                Icon.ICON_RECEIPT_VOUCHER_NEW.getImageDescriptor(IconSize.ToolbarIconSize), null, Constants.TOOLBAR_SHOW_NEW_RECEIPTVOUCHER, params)
                .ifPresent(e -> toolbarmgr3.add(e));
        finishToolbar(coolBar, toolBar);
        ...
        createToolItem(toolBar, CommandIds.CMD_OPEN_BROWSER_EDITOR, msg.commandOpenWwwName, msg.commandBrowserTooltip,
                Icon.ICON_WWW.getImageDescriptor(IconSize.ToolbarIconSize), null, Constants.TOOLBAR_SHOW_OPEN_BROWSER, params)
                .ifPresent(e -> toolbarmgr4.add(e));

        createToolItem(toolBar, CommandIds.CMD_OPEN_CALCULATOR, msg.commandCalculatorName, msg.commandCalculatorTooltip,
                Icon.ICON_CALCULATOR.getImageDescriptor(IconSize.ToolbarIconSize), null, Constants.TOOLBAR_SHOW_OPEN_CALCULATOR, null)
                .ifPresent(e -> toolbarmgr4.add(e));

        createToolItem(toolBar, CommandIds.CMD_QRK_EXPORT, msg.commandExportQrkName, msg.commandExportQrkTooltip,
                Icon.ICON_QRK_EXPORT.getImageDescriptor(IconSize.ToolbarIconSize), null, Constants.TOOLBAR_SHOW_QRK_EXPORT, null)
                .ifPresent(e -> toolbarmgr4.add(e));
        finishToolbar(coolBar, toolBar);
    ...
    protected void handleDialogSelection(@UIEventTopic("EditorPart/updateCoolBar") final Event event) {
        if (event != null) {
            updateCoolbar();
        }
    }
    ...
    @Inject
    @org.eclipse.e4.core.di.annotations.Optional
    protected void recreateCoolBar(@UIEventTopic("EditorPart/recreateCoolBar") final Event event) {
        if (event != null) {
    ...
    @Inject
    @Optional
    public void dirtyChanged(@UIEventTopic(UIEvents.Dirtyable.TOPIC_DIRTY) final Event eventData) {
    ...
    private java.util.Optional<ActionContributionItem> createToolItem(final ToolBar toolBar, final String commandId, final ImageDescriptor iconImage,
            final String visiblePreference) {
        return createToolItem(toolBar, commandId, null, null, iconImage, null, visiblePreference, null);
    }

    private java.util.Optional<ActionContributionItem> createToolItem(final ToolBar toolBar, final String commandId, final ImageDescriptor iconImage,
            final ImageDescriptor disabledIcon, final String visiblePreference) {
        return createToolItem(toolBar, commandId, null, null, iconImage, disabledIcon, visiblePreference, null);
    }

    private java.util.Optional<ActionContributionItem> createToolItem(final ToolBar toolBar, final String commandId, final String commandName,
            final String tooltip, final ImageDescriptor iconImage, final ImageDescriptor disabledIcon, final String visiblePreference,
     ...
     * 
     * @param coolbar
     *            which coolbar to use
     * @param toolBar
     *            on which toolbar the icon should be placed
     * @param commandId
     *            which command id should be used
     * @param tooltip
     *            nice tooltip
     * @param iconImage
     *            image for the icon
     * @param disabledIcon
     *            if it is disabled, which icon should be displayed?
     * @param visiblePreference
     *            id of the preference setting for the visibility
     * @param withChevron
     *            <code>true</code> if a chevron button should be created
     */
    private java.util.Optional<ActionContributionItem> createToolItem(final ToolBar toolBar, final String commandId, final String commandName,
            final String tooltip, final ImageDescriptor iconImage, final ImageDescriptor disabledIcon, final String visiblePreference,
            final Map<String, Object> params, final boolean withChevron) {
        ...
        try {
            if (pCmd != null) {
                ...
                item = withChevron ? new FakturamaCoolbarAction(pCmd, toolBar, IAction.AS_DROP_DOWN_MENU)
                        : new FakturamaCoolbarAction(pCmd, toolBar, IAction.AS_PUSH_BUTTON);
