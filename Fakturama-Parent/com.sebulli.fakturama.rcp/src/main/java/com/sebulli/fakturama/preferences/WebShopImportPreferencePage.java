...
public class WebShopImportPreferencePage extends FieldEditorPreferencePage implements IInitializablePreference {
    ...
    public void createFieldEditors() {
        ...
        final StringFieldEditor passwordEditor = new StringFieldEditor(Constants.PREFERENCES_WEBSHOP_PASSWORD, msg.startFirstSelectDbCredentialsPassword,
        ...
        addField(
                new StringFieldEditor(Constants.PREFERENCES_WEBSHOP_SHIPPING_CATEGORY, msg.preferencesWebshopLabelShippingsincategory, getFieldEditorParent()));

        addField(new BooleanFieldEditor(Constants.PREFERENCES_WEBSHOP_NOTIFY_PROCESSING, msg.preferencesWebshopNotifycustomerOnprogress,
                getFieldEditorParent()));
        ...
        final Button b = new Button(getFieldEditorParent(), SWT.PUSH);
        ...
        b.addSelectionListener(SelectionListener.widgetSelectedAdapter(e -> {
            ...
            context.get("activeShell");
            final WebShopStatusSettingsDialog dialog = ContextInjectionFactory.make(WebShopStatusSettingsDialog.class, context);
            dialog.open();
        }));
    ...
    /**
     * Add Hook to inform gui about enabling/disabling webshop
     */
    @Override
    public boolean performOk() {
        eventBroker.post("views/navigationUpdate", CommandIds.CMD_WEBSHOP_IMPORT);
