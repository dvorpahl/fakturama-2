...
public class DefaultValuesInitializer extends AbstractPreferenceInitializer {
     ...
     */
    public void registerPreferencePage(final IInitializablePreference preferencePage) {
     ...
     * and then set the default values on it. The default values are only in
     * memory and not persisted somewhere! Only the "real" values are persisted
     * in PreferenceStore.
     * 
