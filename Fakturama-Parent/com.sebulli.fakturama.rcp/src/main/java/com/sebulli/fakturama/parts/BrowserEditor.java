...
public class BrowserEditor {
        ...
        if (this.isFakturamaProjectUrl) {
            ...
            if (StringUtils.isBlank(getPreferences().getString(Constants.GENERAL_WORKSPACE))) {
                ...
                if (url.isEmpty() || url.equals(OpenBrowserEditorHandler.FAKTURAMA_PROJECT_URL)) {
                    url = "file://" + StringUtils.appendIfMissing(getPreferences().getString(Constants.GENERAL_WORKSPACE).replaceAll("\\\\", "/"), "/")
                            + StringUtils.appendIfMissing(msg.configWorkspaceTemplatesName, "/") + "Start/start.html";
                }
            }
        }
        ...
        try {
            ...
            browser.addProgressListener(new ProgressListener() {
                ...
                public void changed(final ProgressEvent event) {
                    ...
                    if ((browserURL.startsWith(OpenBrowserEditorHandler.FAKTURAMA_PROJECT_URL) && !browserURL.startsWith("http://www.fakturama.org/mantis"))
                            || !isValidURL || !isFakturamaProjectUrl) {
     ...
     * @param url
     */
    public void resetUrl(final String url) {
     ...
     */
    public void fillForm(final Browser browser) {
        this.browser = browser;
    }

    /**
     * Test the parcel service form. Fills all form elements with its names and
