...
public class ExpenditureVoucherListTable extends AbstractViewDataTable<Voucher, VoucherCategory>/* extends AbstractVoucherListTable*/ {
    ...
    public NatTable createListTable(final Composite searchAndTableComposite) {
        ...
        */
        ...
        final FilterList<Voucher> textFilteredIssues = new FilterList<>(expenditureListData, textMatcherEditor);
    ...
    @Inject
    @Optional
    public void handleRefreshEvent(@UIEventTopic(ExpenditureVoucherEditor.EDITOR_ID) final String message) {
