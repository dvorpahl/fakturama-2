...
/**
 * Converter for percentage values. Can also convert double values (in contrast
 * to native NatTable converter).
 *
 */
public class DoublePercentageDisplayConverter extends DisplayConverter {
     ...
     * @param localeUtil
     */
    public DoublePercentageDisplayConverter(final ILocaleService localeUtil) {
