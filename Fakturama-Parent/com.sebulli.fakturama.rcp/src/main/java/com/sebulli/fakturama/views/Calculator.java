...
public class Calculator {
     ...
     * @param isResult
     */
    private void setDisplayString(final String displayString, final boolean isResult) {
     ...
     *            The operator
     */
    private void updateCalc(final char keyPressed) {
        char keyVal = keyPressed;
     ...
     */
    private Label createButton(final Composite parent, final char c, final boolean isCalc, final Icon commandIcon, final int vspan) {
        // Create a button
