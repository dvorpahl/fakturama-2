...
public class ParcelServiceManager implements IParcelService {
    ...
    public void setPrefs(final IEclipsePreferences pref) {
        ...
        try {
            ...
            newDirectoryStream.forEach(file -> {
                ...
                if (file.toString().endsWith(".txt")) {
                    ...
                    try (BufferedInputStream stream = new BufferedInputStream(Files.newInputStream(file)); Reader in = new InputStreamReader(stream, "UTF8");) {
    ...
    /**
     * Returns the template path for parcel service templates relative to the
     * workspace
     * 
     * @return
     */
     ...
     * 
     * @return The number of properties entries
     */
    @Override
    public int size() {
     ...
     * @return The name of the parcel service
     */
    @Override
     ...
     * 
     * @return The name of the active parcel service
     */
    @Override
     ...
     * @param i
     *            The number of the properties object
     * @return The URL of the parcel service
     */
     ...
     * 
     * @return The URL of the active parcel service
     */
    @Override
     ...
     * 
     * @return The active properties object
     */
    @Override
