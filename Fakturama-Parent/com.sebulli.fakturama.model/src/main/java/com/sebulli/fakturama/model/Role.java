...
public class Role extends ModelObject implements IEntity, Serializable, Cloneable {
    /**
     * A common serial ID.
     * 
     * @generated
     ...
     * @generated
     */
    public boolean isSameAs(Role other) {
        boolean retval = true;
        if (other != null) {
    ...
    /**
     * Sets the '{@link Role#getName() <em>name</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The name is equal to account name. <!-- end-model-doc -->
     * 
     * @param newName
     *            the new value of the '{@link Role#getName() name}' feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link Role#getDateAdded() <em>dateAdded</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The date when the entity was added. <!-- end-model-doc -->
     * 
     * @param newDateAdded
     *            the new value of the '{@link Role#getDateAdded() dateAdded}'
     *            feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link Role#getModifiedBy() <em>modifiedBy</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newModifiedBy
     *            the new value of the '{@link Role#getModifiedBy() modifiedBy}'
     *            feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link Role#getModified() <em>modified</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newModified
     *            the new value of the '{@link Role#getModified() modified}'
     *            feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link Role#getId() <em>id</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newId
     *            the new value of the '{@link Role#getId() id}' feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link Role#getDeleted() <em>deleted</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * Indicates if the entity has been deleted. <!-- end-model-doc -->
     * 
     * @param newDeleted
     *            the new value of the '{@link Role#getDeleted() deleted}'
     *            feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link Role#getValidFrom() <em>validFrom</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The date from which this entity should be valid (used for historized
     * entities). <!-- end-model-doc -->
     * 
     * @param newValidFrom
     *            the new value of the '{@link Role#getValidFrom() validFrom}'
     *            feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link Role#getValidTo() <em>validTo</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The date until this entity should be valid (used for historized
     * entities). <!-- end-model-doc -->
     * 
     * @param newValidTo
     *            the new value of the '{@link Role#getValidTo() validTo}'
     *            feature.
     * @generated
     */
    ...
    public String toString() {
        return "Role" + " name: [" + getName() + "]" + " dateAdded: [" + getDateAdded() + "]" + " modifiedBy: [" + getModifiedBy() + "]" + " modified: ["
