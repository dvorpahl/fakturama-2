...
/**
 * This class is a helper for the name conversion of data table attributes. The
 * entity classes holds them as camelCase, but the database columns are named
 * with underscores. So, an attribute like accountHolder (from Contacts) is
 * stored as ACCOUNT_HOLDER in database.
 * 
