...
@PrimaryKeyJoinColumns({ @PrimaryKeyJoinColumn(name = "INVOICE_PARENT_ID") })
public class Invoice extends Document implements Cloneable {
    /**
     * A common serial ID.
     * 
     * @generated
     ...
     * @generated
     */
    public boolean isSameAs(Invoice other) {
        boolean retval = true;
        if (other != null) {
        } else {
            retval = false;
