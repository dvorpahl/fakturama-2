 ...
 */
@Entity()
@Table(name = "FKT_TENANT")
@EntityListeners(value = { EntityListener.class })
public class Tenant extends ModelObject implements Serializable, IEntity, Cloneable {
    /**
     * A common serial ID.
     * 
     * @generated
     ...
     * @generated
     */
    public boolean isSameAs(Tenant other) {
        boolean retval = true;
        if (other != null) {
    ...
    /**
     * Sets the '{@link Tenant#getName() <em>name</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The name is equal to account name. <!-- end-model-doc -->
     * 
     * @param newName
     *            the new value of the '{@link Tenant#getName() name}' feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link Tenant#getDateAdded() <em>dateAdded</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The date when the entity was added. <!-- end-model-doc -->
     * 
     * @param newDateAdded
     *            the new value of the '{@link Tenant#getDateAdded() dateAdded}'
     *            feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link Tenant#getModifiedBy() <em>modifiedBy</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newModifiedBy
     *            the new value of the '{@link Tenant#getModifiedBy()
     *            modifiedBy}' feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link Tenant#getModified() <em>modified</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newModified
     *            the new value of the '{@link Tenant#getModified() modified}'
     *            feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link Tenant#getId() <em>id</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newId
     *            the new value of the '{@link Tenant#getId() id}' feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link Tenant#getDeleted() <em>deleted</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * Indicates if the entity has been deleted. <!-- end-model-doc -->
     * 
     * @param newDeleted
     *            the new value of the '{@link Tenant#getDeleted() deleted}'
     *            feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link Tenant#getValidFrom() <em>validFrom</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The date from which this entity should be valid (used for historized
     * entities). <!-- end-model-doc -->
     * 
     * @param newValidFrom
     *            the new value of the '{@link Tenant#getValidFrom() validFrom}'
     *            feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link Tenant#getValidTo() <em>validTo</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The date until this entity should be valid (used for historized
     * entities). <!-- end-model-doc -->
     * 
     * @param newValidTo
     *            the new value of the '{@link Tenant#getValidTo() validTo}'
     *            feature.
     * @generated
     */
    ...
    public String toString() {
        return "Tenant" + " name: [" + getName() + "]" + " dateAdded: [" + getDateAdded() + "]" + " modifiedBy: [" + getModifiedBy() + "]" + " modified: ["
                + getModified() + "]" + " id: [" + getId() + "]" + " deleted: [" + getDeleted() + "]" + " validFrom: [" + getValidFrom() + "]" + " validTo: ["
                + getValidTo() + "]";
    }
}
