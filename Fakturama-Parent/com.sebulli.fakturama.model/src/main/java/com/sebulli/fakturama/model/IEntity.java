...
public interface IEntity {
    ...
    /**
     * Sets the '{@link IEntity#getDateAdded() <em>dateAdded</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newDateAdded
     *            the new value of the '{@link IEntity#getDateAdded()
    ...
    /**
     * Sets the '{@link IEntity#getModifiedBy() <em>modifiedBy</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newModifiedBy
     *            the new value of the '{@link IEntity#getModifiedBy()
    ...
    /**
     * Sets the '{@link IEntity#getModified() <em>modified</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newModified
     *            the new value of the '{@link IEntity#getModified()
    ...
    /**
     * Sets the '{@link IEntity#getValidFrom() <em>validFrom</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newValidFrom
     *            the new value of the '{@link IEntity#getValidFrom()
    ...
    /**
     * Sets the '{@link IEntity#getValidTo() <em>validTo</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newValidTo
     *            the new value of the '{@link IEntity#getValidTo()
