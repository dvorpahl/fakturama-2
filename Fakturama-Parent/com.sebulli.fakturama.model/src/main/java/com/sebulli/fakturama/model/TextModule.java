...
public class TextModule extends ModelObject implements Serializable, IEntity, ICategorizable<TextCategory>, Cloneable {
    /**
     * A common serial ID.
     * 
     * @generated
    ...
    private TextCategory categories = null;
     ...
     * @generated
     */
    public boolean isSameAs(TextModule other) {
        boolean retval = true;
        if (other != null) {
            if (text != null && other.getText() != null) {
                retval &= text.compareTo(other.getText()) == 0;
            }
    ...
    @Override
    public TextModule clone() {
        TextModule retval = new TextModule();
        retval.setText(this.getText());
     ...
     * @generated
     */
    public TextCategory getCategories() {
     ...
     * @generated
     */
    public void setCategories(TextCategory newCategories) {
    ...
    /**
     * Sets the '{@link TextModule#getDateAdded() <em>dateAdded</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The date when the entity was added. <!-- end-model-doc -->
     * 
     * @param newDateAdded
     *            the new value of the '{@link TextModule#getDateAdded()
     *            dateAdded}' feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link TextModule#getModifiedBy() <em>modifiedBy</em>}'
     * feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newModifiedBy
     *            the new value of the '{@link TextModule#getModifiedBy()
     *            modifiedBy}' feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link TextModule#getValidFrom() <em>validFrom</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The date from which this entity should be valid (used for historized
     * entities). <!-- end-model-doc -->
     * 
     * @param newValidFrom
     *            the new value of the '{@link TextModule#getValidFrom()
     *            validFrom}' feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link TextModule#getValidTo() <em>validTo</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The date until this entity should be valid (used for historized
     * entities). <!-- end-model-doc -->
     * 
     * @param newValidTo
     *            the new value of the '{@link TextModule#getValidTo() validTo}'
     *            feature.
     * @generated
     */
    ...
    public String toString() {
        return "TextModule" + " text: [" + getText() + "]" + " name: [" + getName() + "]" + " dateAdded: [" + getDateAdded() + "]" + " modifiedBy: ["
