...
public class ProductOptions extends ModelObject implements Serializable, IEntity, Cloneable {
    /**
     * A common serial ID.
     * 
     * @generated
     ...
     * @generated
     */
    public boolean isSameAs(ProductOptions other) {
        boolean retval = true;
        if (other != null) {
            if (attributeValue != null && other.getAttributeValue() != null) {
                retval &= attributeValue.compareTo(other.getAttributeValue()) == 0;
            }
            if (sequenceNumber != null && other.getSequenceNumber() != null) {
                retval &= sequenceNumber.compareTo(other.getSequenceNumber()) == 0;
            }
    ...
    @Override
    public ProductOptions clone() {
        ProductOptions retval = new ProductOptions();
        retval.setAttributeValue(this.getAttributeValue());
        retval.setSequenceNumber(this.getSequenceNumber());
    ...
    public void setAttributeValue(String newAttributeValue) {
        firePropertyChange("attributeValue", this.attributeValue, newAttributeValue);
    ...
    public void setSequenceNumber(Integer newSequenceNumber) {
        firePropertyChange("sequenceNumber", this.sequenceNumber, newSequenceNumber);
    ...
    /**
     * Sets the '{@link ProductOptions#getName() <em>name</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The name is equal to account name. <!-- end-model-doc -->
     * 
     * @param newName
     *            the new value of the '{@link ProductOptions#getName() name}'
     *            feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link ProductOptions#getDateAdded() <em>dateAdded</em>}'
     * feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The date when the entity was added. <!-- end-model-doc -->
     * 
     * @param newDateAdded
     *            the new value of the '{@link ProductOptions#getDateAdded()
     *            dateAdded}' feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link ProductOptions#getModifiedBy() <em>modifiedBy</em>}'
     * feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newModifiedBy
     *            the new value of the '{@link ProductOptions#getModifiedBy()
     *            modifiedBy}' feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link ProductOptions#getModified() <em>modified</em>}'
     * feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newModified
     *            the new value of the '{@link ProductOptions#getModified()
     *            modified}' feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link ProductOptions#getDeleted() <em>deleted</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * Indicates if the entity has been deleted. <!-- end-model-doc -->
     * 
     * @param newDeleted
     *            the new value of the '{@link ProductOptions#getDeleted()
     *            deleted}' feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link ProductOptions#getValidFrom() <em>validFrom</em>}'
     * feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The date from which this entity should be valid (used for historized
     ...
     * 
     * @param newValidFrom
     *            the new value of the '{@link ProductOptions#getValidFrom()
     *            validFrom}' feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link ProductOptions#getValidTo() <em>validTo</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The date until this entity should be valid (used for historized
     * entities). <!-- end-model-doc -->
     * 
     * @param newValidTo
     *            the new value of the '{@link ProductOptions#getValidTo()
     *            validTo}' feature.
     * @generated
     */
    ...
    public String toString() {
        return "ProductOptions" + " attributeValue: [" + getAttributeValue() + "]" + " sequenceNumber: [" + getSequenceNumber() + "]" + " name: [" + getName()
