 ...
 * begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> *** FOR
 * FURTHER USE*** Not yet implemented!!! <!-- end-model-doc -->
 * 
 * @generated
 */
@Entity()
...
public class User extends ModelObject implements IEntity, Serializable, Cloneable {
    /**
     * A common serial ID.
     * 
     * @generated
    ...
    @JoinColumns({ @JoinColumn(name = "FK_TENANT") })
    private Tenant tenant = null;

    /**
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The username for this user. This entry is used for authentication. <!--
     * end-model-doc -->
     * 
     * @generated
     */
    ...
    public boolean isSameAs(User other) {
        ...
        if (other != null) {
            if (password != null && other.getPassword() != null) {
                retval &= password.compareTo(other.getPassword()) == 0;
            }
            if (getTenant() != null) {
                retval &= getTenant().isSameAs(other.getTenant());
            }
            if (userName != null && other.getUserName() != null) {
                retval &= userName.compareTo(other.getUserName()) == 0;
            }
            /* reference to a Set (roles) or a volatile member cannot be compared... */
    ...
    public User clone() {
        ...
        retval.setTenant(this.getTenant());
        retval.setUserName(this.getUserName());
        /* reference to a Set (roles) cannot be compared... */
    ...
    public void setPassword(String newPassword) {
        firePropertyChange("password", this.password, newPassword);
        password = newPassword;
    }

    /**
     * Returns the value of '<em><b>tenant</b></em>' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @return the value of '<em><b>tenant</b></em>' feature
     * @generated
     */
    ...
    /**
     * Sets the '{@link User#getTenant() <em>tenant</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newTenant
     *            the new value of the '{@link User#getTenant() tenant}'
     *            feature.
     * @generated
     */
    public void setTenant(Tenant newTenant) {
        firePropertyChange("tenant", this.tenant, newTenant);
        tenant = newTenant;
    }
    ...
    public void setUserName(String newUserName) {
        firePropertyChange("userName", this.userName, newUserName);
    ...
    /**
     * Sets the '{@link User#getRoles() <em>roles</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newRoles
     *            the new value of the '{@link User#getRoles() roles}' feature.
     * @generated
     */
    public void setRoles(List<Role> newRoles) {
        firePropertyChange("roles", this.roles, newRoles);
        roles = newRoles;
    }
    ...
    /**
     * Sets the '{@link User#getDateAdded() <em>dateAdded</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The date when the entity was added. <!-- end-model-doc -->
     * 
     * @param newDateAdded
     *            the new value of the '{@link User#getDateAdded() dateAdded}'
     *            feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link User#getModifiedBy() <em>modifiedBy</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newModifiedBy
     *            the new value of the '{@link User#getModifiedBy() modifiedBy}'
     *            feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link User#getModified() <em>modified</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newModified
     *            the new value of the '{@link User#getModified() modified}'
     *            feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link User#getId() <em>id</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param newId
     *            the new value of the '{@link User#getId() id}' feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link User#getDeleted() <em>deleted</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * Indicates if the entity has been deleted. <!-- end-model-doc -->
     * 
     * @param newDeleted
     *            the new value of the '{@link User#getDeleted() deleted}'
     *            feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link User#getValidFrom() <em>validFrom</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The date from which this entity should be valid (used for historized
     * entities). <!-- end-model-doc -->
     * 
     * @param newValidFrom
     *            the new value of the '{@link User#getValidFrom() validFrom}'
     *            feature.
     * @generated
     */
    ...
    /**
     * Sets the '{@link User#getValidTo() <em>validTo</em>}' feature.
     *
     * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
     * The date until this entity should be valid (used for historized
     * entities). <!-- end-model-doc -->
     * 
     * @param newValidTo
     *            the new value of the '{@link User#getValidTo() validTo}'
     *            feature.
     * @generated
     */
    ...
    public String toString() {
        return "User" + " password: [" + getPassword() + "]" + " userName: [" + getUserName() + "]" + " name: [" + getName() + "]" + " dateAdded: ["
