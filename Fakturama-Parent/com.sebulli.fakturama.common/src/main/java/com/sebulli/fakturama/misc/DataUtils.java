...
public class DataUtils {
    ...
    /**
     * <p>
     * Refreshes the settings of this class.
     * </p>
     * <p>
     * <i>Caution:</i> This method makes the {@link DataUtils} class not thread
     * safe, anymore. If multiple threads are try to refresh this class the
     * state becomes indeterminable.
     */
    public void refresh() {
        instance = null;
    }
    ...
    /**
     * Update the currency symbol and the thousands separator from the
     * preferences
     * 
     * @param localeUtil
     */
    ...
    public void setLocaleUtil(final ILocaleService localeUtil) {
    ...
    public MonetaryRounding getRounding(final CurrencyUnit currencyUnit, final boolean cashRounding) {
        return Monetary.getRounding(RoundingQueryBuilder.of().setCurrency(currencyUnit).setProviderName(FakturamaMonetaryRoundingProvider.DEFAULT_ROUNDING_ID)
                .setScale(getPreferenceStore().getInt(Constants.PREFERENCES_GENERAL_CURRENCY_DECIMALPLACES)).set("cashRounding", cashRounding).build());
    }
    ...
    public MonetaryRounding getRounding(final CurrencyUnit currencyUnit) {
    ...
    public Double round(final Double d, final int scale) {
     ...
     * @return Gross value as string
     */
    public MonetaryAmount CalculateGrossFromNet(final MonetaryAmount netValue, final Double vat) {
        return netValue.multiply(1 + vat);
    }

    public Double CalculateGrossFromNet(final Double netValue, final Double vat) {
     ...
     */
    public MonetaryAmount calculateNetFromGross(final String gross, final Double vat) {
     ...
     * @return Net value as string
     */
    public MonetaryAmount calculateNetFromGross(final Double gross, final Double vat) {
     ...
     */
    @Deprecated
    public MonetaryAmount calculateNetFromGross(final String gross, final Double vat, final MonetaryAmount netvalue) {
     ...
     * @return the double
     */
    public Double calculateNetFromGrossAsDouble(final Double gross, final Double vat) {
     ...
     */
    public LocalDateTime addToDate(final Date date, final int days) {
     ...
     * @return The new string without them
     */
    public String removeCR(final String s) {
     ...
     * @return The new string without them
     */
    public String makeOSLineFeeds(final String s) {
     ...
     */
    public boolean MultiLineStringsAreEqual(final String s1, final String s2) {
        return removeCR(s1).equals(removeCR(s2));
    }

    /**
     * Converts all \r\n to \n \r\n are Generated by SWT text controls on a
     * windows system.
     * 
     * @param s
     ...
     * @return
     */
    public String getSingleLine(final String s) {
    ...
    public boolean isDoubleZero(final Double doubleToTest) {
