...
public class DateFormatter implements IDateFormatterService {
     ...
     */
    @Override
    public String DateAsISO8601String(final String s) {
     ...
     */
    @Override
    public String getDateAndTimeAsString(final Calendar calendar) {
     ...
     */
    @Override
    public String getDateTimeAsString(final Calendar calendar) {
     ...
     */
    @Override
    public String getDateTimeAsLocalString(final GregorianCalendar calendar) {
        DateFormat df = DateFormat.getDateInstance(DateFormat.MEDIUM);
        return df.format(calendar.getTime());
    }
     ...
     */
    @Override
    public String getFormattedLocalizedDate(final Date date) {
        if (date != null) {
     ...
     */
    @Override
    public GregorianCalendar getCalendarFromDateString(final String date) {
        GregorianCalendar calendar = new GregorianCalendar();
        calendar.clear();
