...
public interface INumberFormatterService {
    ...
    /**
     * Parse a price (given as String) and return its value as Double. Uses the
     * current Money format.
     * 
     * @param value
     * @return
     */
    ...
    String formatCurrency(MonetaryAmount amount, Locale locale, CurrencySettingEnum useCurrencySymbol, boolean cashRounding, boolean useSeparator);

    /**
     * The currently used currency symbol, according to the preferences (symbol,
     * ISO code or nothing at all).
     * 
     ...
     *            the use currency symbol
     * @param cashRounding
     *            the cash rounding
     * @return the formatted string
     */
    String formatCurrency(double myNumber, Locale locale, CurrencySettingEnum useCurrencySymbol, boolean cashRounding, boolean useSeparator);
